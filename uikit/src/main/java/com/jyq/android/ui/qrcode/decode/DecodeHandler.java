...
package com.jyq.android.ui.qrcode.decode;
...
import com.jyq.android.ui.qrcode.Intents;
...
final class DecodeHandler extends Handler {
  ...
  public void handleMessage(Message message) {
    ...
    switch (message.what) {
      case Intents.Scan.DECODE:
        decode((byte[]) message.obj, message.arg1, message.arg2);
        break;
      case Intents.Scan.QUIT:
        running = false;
  ...
  private void decode(byte[] data, int width, int height) {
    ...
    if (rawResult != null) {
      if (handler != null) {
        ...
        Message message = Message.obtain(handler, Intents.Scan.DECODE_SUCCEEDED, rawResult);
      ...
      if (handler != null) {
        Message message = Message.obtain(handler, Intents.Scan.DECODE_FAILED);
        message.sendToTarget();
      }
    }
  }
