...
package com.jyq.android.ui.qrcode.camera;
...
import com.jyq.android.ui.qrcode.camera.open.OpenCamera;
import com.jyq.android.ui.qrcode.camera.open.OpenCameraInterface;
...
public final class CameraManager {
  ...
  public synchronized Rect getFramingRect() {
    if (framingRect == null) {
      ...
      framingRect = new Rect(leftOffset, (int)laserFrameTopMargin, leftOffset + width, (int)laserFrameTopMargin + height);
...
/*    public synchronized void setManualCameraId(int cameraId) {
  ...
  public synchronized void setManualFramingRect(float width, float height) {
    if (initialized) {
      ...
      int statusBarHeight = getStatusBarHeight();//状态栏高度
      float leftOffset = (screenResolution.x - width) / 2;
      float topOffset = (screenResolution.y - height) / 2 - statusBarHeight;
      if (laserFrameTopMargin == 0)
        laserFrameTopMargin = topOffset;
      else {
        laserFrameTopMargin += statusBarHeight;
      }
      framingRect = new Rect((int)leftOffset, (int)laserFrameTopMargin, (int)(leftOffset + width), (int)(laserFrameTopMargin + height));
   ...
   */
  public void setLaserFrameTopMargin(float laserFrameTopMargin) {
